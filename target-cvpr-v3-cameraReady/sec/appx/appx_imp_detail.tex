...
Our code for adapting SAM2Act+ can be found at \url{https://github.com/RoboMME/SAM2Act}
...
\end{lstlisting}
\end{tcolorbox}
\caption{Example Prompt for VLM Grounded Subgoal Prediction. This is used to generate grounded subgoals for the \textsc{GroundSG} VLA policy.}
...
\end{lstlisting}
\end{tcolorbox}
\caption{Example Prompt for MemER Baseline. We use grounded subgoals for them since we found grounded subgoals are better.}
