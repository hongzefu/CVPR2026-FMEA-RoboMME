...
All tasks in \benchname\xspace are non-Markovian by design: identical observations may arise from different histories and require different actions.
...
\benchname\xspace organizes these four dimensions into task suites \TSone, \TStwo, \TSthree, and \TSfour; \cref{tab:task_overview} and \cref{fig:teaser} summarize all tasks, with detailed descriptions in \cref{sec:appx_task_desc}.
