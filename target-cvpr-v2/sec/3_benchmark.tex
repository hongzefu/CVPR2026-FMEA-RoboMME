...
\rowcolor{rowgray}\cellcolor{white}\multirow{-4}{=}{\wrapttlabel{Counting}} & {StopCube} & T & 317 &\text{count, time-critical} &
...
\rowcolor{rowgray}\cellcolor{white}\multirow{-4}{=}{\wrapttlabel{Permanence}} & ButtonUnmaskSwap & S & 400 & \text{occlusion, tracking} &
...
\rowcolor{rowgray}\cellcolor{white}\multirow{-4}{=}{\wrapttlabel{Reference}} &
...
% ================= Behavior =================
& MoveCube & P & 394  & \text{contact-mode},\hspace{4pt}\text{tool-use} &
...
\rowcolor{rowgray}\cellcolor{white}\multirow{-4}{=}{\wrapttlabel{Imitation}} & RouteStick & P & 370  &  \text{circular-motion} &
